...
public class DerbyInsert extends AbstractMethod {
     ...
     * @since 3.5.4
     */
    public DerbyInsert(boolean ignoreAutoIncrementColumn) {
        this(SqlMethod.INSERT_ONE.getMethod());
     ...
     * @since 3.5.0
     */
    public DerbyInsert(String name) {
        super(name);
    }
     ...
     * @since 3.5.4
     */
    public DerbyInsert(String name, boolean ignoreAutoIncrementColumn) {
        super(name);
        this.ignoreAutoIncrementColumn = ignoreAutoIncrementColumn;
    }
