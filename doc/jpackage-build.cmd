...
# build osx
jpackage --input sdwan-node-bootstrap/target/package/ --name net-thunder --main-jar sdwan-node-bootstrap.jar --main-class org.springframework.boot.loader.launch.JarLauncher --verbose
